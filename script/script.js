...
let scrollend = gsap.to('chapt.no4-5', {
    scrollTrigger: {
        trigger: 'chapt.no4-5',
        onUpdate: (e) => {
...
const chapt4_5 = gsap.timeline({
    ...
    chapt4_5
    .to('#chapitre-4-5 .text', {opacity: 1},"<")
    ...
    .to('#chapitre-4-5 .text', {y: '-150vh', ease: 'power1.inOut'},"<")
    .to('#chapitre-4-5 .text-2', {opacity: 1})
...
const chapt6 = gsap.timeline({
    ...
    chapt6
    .to('#chapitre-6 .text', {opacity: 1})
    .to('#chapitre-6 .fusee', {rotate: 90, duration: 0},'<')
    .to('#chapitre-6 .planete-1', {x: hauteurTotale*-0.35},'<')
    .to('#chapitre-6 .planete-2', {x: hauteurTotale*-0.60},'<')
